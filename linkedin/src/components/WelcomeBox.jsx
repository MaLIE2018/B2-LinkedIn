...
class WelcomeBox extends React.Component {
	...
	render() {
		return (
			<>
				<Card className="mt-3 roundedCircle">
					<Card.Img
						id="bg-img"
						variant="top"
					...
					<Image id="image-icon" src={welcome} roundedCircle />

					<Card.Body>
						<Card.Title className="text-center mt-5 text-dark mb-2 pb-0 underline">
							<strong>Welcome, Ankit!</strong>
						</Card.Title>
						<a className="d-flex justify-content-center mt-0 pt-0 underline">
							Add a photo
						</a>
						<Card.Text></Card.Text>
					</Card.Body>
